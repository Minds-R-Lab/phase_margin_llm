...
\author{%
  ...
  \texttt{anonymous.author@example.org}
}
\date{}
...
analysis scripts are released alongside the paper at an
\textbf{anonymised repository link in the supplementary
material}.  Each benchmark is
